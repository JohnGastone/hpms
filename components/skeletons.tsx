...
export function PatientCardSkeleton() {
  return (
    <div className="bg-white rounded-2xl ring-1 ring-slate-100 border-l-4 border-l-slate-100 p-5 space-y-3">
...
export function DashboardStatSkeleton() {
  return (
    <div className="bg-white rounded-2xl ring-1 ring-slate-100 p-4 space-y-3">
  ...
  return (
    <div className="grid grid-cols-5 gap-3">
      {Array.from({ length: 5 }).map((_, i) => (
        <div key={i} className="bg-white rounded-2xl ring-1 ring-slate-100 p-4 text-center space-y-2">
